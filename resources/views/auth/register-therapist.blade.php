...
<x-guest-layout>
    <form method="POST" action="{{ route('register-therapist') }}">
        @csrf
            ...
            <div class="form_area">
                ...
                <form action="">
                    ...
                    <div class="form_group">
                        ...
                        <x-text-input placeholder="Enter your password" id="password" class="form_style" type="password" name="password" :value="old('password')" required autocomplete="new-password" />
                    ...
                    <div class="form_group">
                        <label class="sub_title" for="license_id">License ID</label>
                        <x-text-input placeholder="Enter your license id" id="license_id" class="form_style" type="number" name="license_id" :value="old('license_id')" required min="1000000" max="9999999" />
